...
To build the final jar and optimize the stoFact application for production, run:
...
Then navigate to [http://localhost:8073](http://localhost:8073) in your browser.
